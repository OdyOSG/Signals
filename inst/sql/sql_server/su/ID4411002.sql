...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (19097821)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (19097821)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (1594973,1597756,1560171,1559684,1502809,1502855)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (1594973,1597756,1560171,1559684,1502809,1502855)
  and c.invalid_reason is null
...
JOIN #Codesets cs on (o.observation_concept_id = cs.concept_id and cs.codeset_id = 66)
) C
...
(
  ...
  FROM @cdm_database_schema.OBSERVATION o
JOIN #Codesets cs on (o.observation_concept_id = cs.concept_id and cs.codeset_id = 67)
) C
